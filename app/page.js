  ...
  return (
    <div className="bg-gradient-to-r from-indigo-300 to-purple-200 min-h-screen text-gray-800">
      ...
      <section id="about" className="py-20 px-10 text-center bg-indigo-100">
        ...
        <div className="mt-6">
          <Image
            src="/profile.jpg" // Ganti dengan gambar profil kamu
            alt="Profile Picture"
            width={150}
            height={150}
        ...
        <p className="mt-6 text-lg text-gray-600">
          Hallo, saya Arumdafta, seorang mahasiswa di bidang Sistem Informasi. Saya sangat tertarik dengan teknologi, pengkodean, dan menciptakan solusi berbasis web.
        </p>
      </section>
      ...
      <section id="contact" className="py-20 px-10 text-center bg-purple-100">
        ...
        <div className="mt-6">
          ...
          <div className="flex justify-center gap-6 mt-4">
            {/* GitHub Emoticon */}
            <a href="https://github.com/arumdafta" target="_blank" className="text-gray-700">
              <span className="text-3xl">🐙</span> {/* Github Octocat Emoticon */}
            </a>

            {/* LinkedIn Emoticon */}
            <a href="https://www.linkedin.com/in/arumdafta-nawa-hagiaza-84983927a/" target="_blank" className="text-gray-700">
              <span className="text-3xl">🔗</span> {/* LinkedIn Emoticon */}
            </a>

            {/* Email Emoticon */}
            <a href="mailto:nawahagiazaa@gmail.com" className="text-gray-700">
